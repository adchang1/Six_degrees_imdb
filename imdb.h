 ...
 */
 ...
 private:
  bool verifyActor(int *foundIndex, const std::string& player) const;
  bool verifyFilm(int *foundIndex, const film& movie) const;
  film constructFilmStruct(void *filmPtr) const;
  int *returnFoundIndexActorPtr(const std::string& player) const;
  int *returnFoundIndexMoviePtr(const film& movie) const;
